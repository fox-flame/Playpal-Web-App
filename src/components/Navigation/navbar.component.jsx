      ...
      >
        <div className="sidenav-header">
          ...
          >
            <img
              ...
              alt="main_logo"
            />
            <span className="ms-1 font-weight-bold">PlayPal Admin</span>
          </a>
        </div>
        ...
        >
          <ul className="navbar-nav">
            {currentUser == null ? (
              <Navlink name={"Login"} url={""} active={"active"}>
                <HomeIcon />
              </Navlink>
            ) : (
              <>
                ...
                <Navlink name={"Coach Requests"} url={"/coaches"}>
                  <CoachIcon />
                </Navlink>
              </>
            )}
